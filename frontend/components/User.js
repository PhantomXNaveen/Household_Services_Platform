          ...
          <table class="table table-striped shadow-sm">
            ...
            <tbody>
              <tr v-for="user in filteredUsers" :key="user.id">
                ...
                <td><button v-if="$store.state.role === 'Admin'" class="btn btn-info btn-sm" @click="flag(user.id,!user.active)">{{ user.active ? 'Flag' : 'Unflag' }}</button></td>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form @submit.prevent="updateUser">
                  ...
                  <div v-if="this.roleHaiye !=='Customer'" class="form-group mb-3">
      ...
      async flag(user_id, flagval){
        try {
            const response = await fetch(`/api/users/${user_id}`, {
                ...
                body: JSON.stringify({"active":flagval}),
            });
            ...
            if (response.ok) {
                ...
                this.errorMessage = errorData.message || 'Failed to add User.';
            }
        } catch (error) {
